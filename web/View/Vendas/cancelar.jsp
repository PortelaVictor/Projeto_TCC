                ...
                <div class="col-lg-12">
                    <div id="list" class="row">
                        <div class="table-responsive col-md-12">
                            ...
                            %>    
                            <form action="cancelarvenda.jsp" method="post">
                                <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                        <label for="id">ID:</label>
                                        <input type="text" class="form-control" name="id" id="id" value="<%=v.getId()%>">
                                    </div>
                                    <%  
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control" name="dvenda" value="<%=v.getDvenda()%>" required >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="contato">Contato:</label>
                                        <input type="text" class="form-control" name="contato" id="contato" value="<%=v.getContato()%>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="numero">Numero:</label>
                                        <input type="text" class="form-control" name="numero" id="numero" value="<%=v.getNumero()%>" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="total">Total</label>
                                        <input type="number" class="form-control" name="total" id="total" value="<%=v.getTotal()%>" >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <table id="products-table" border="1" width="900px" >	
                                        ...
                                        <tbody>	
                                                    ...
                                                    %>
                                                            <%while(resultset.next()){%>
                                                                <tr> 
                                                                <td><input type="number" class="form-control" name="total" id="item" value="<%= i%>" disabled="disabled"></td>
                                                                <td><%
                                                                        ...
                                                                        while(resultsetProd.next()){%>
                                                                            ...
                                                                            <input type="text" class="form-control" name="total" id="produto" value="<%= resultsetProd.getString(2)%>" disabled="disabled">
                                                                        <%}
                                                                        
                                                                    %></td>
                                                                <td><input type="number" class="form-control" name="total" id="quantidade" value="<%= resultset.getString(4)%>" disabled="disabled"></td>
                                                                <td><input type="number" class="form-control" name="total" id="preco" value="<%= resultset.getString(5)%>" disabled="disabled"></td>
                                                                <td><input type="number" class="form-control" name="total" id="total" value="<%= resultset.getString(6)%>" disabled="disabled"></td>
                                                                </tr> 
                                                            <% i++; }  %>
                                                    <%
                                                        }catch(Exception e){out.println("Entrada errada"+e);}
