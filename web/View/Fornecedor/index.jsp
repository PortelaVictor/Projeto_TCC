<%-- 
    Document   : index
    Created on : 24/09/2017, 18:23:13
    Author     : porte
--%>
                ...
                <div class="col-lg-12">
                    <div id="list" class="row">
                        <div class="table-responsive col-md-12">
                            ...
                            %>
                            <%
                                //Query para apresentar os Forncedores cadastrados e pesqusiar pelo nome cadastrado
                                ...
                                try{
                                    ...
                                    String sql = "SELECT * FROM fornecedor WHERE nome like '%" + pesquisa + "%' " +
                                        "ORDER BY nome ASC ";
